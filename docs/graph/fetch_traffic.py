...
TITLE  = os.environ.get("TRAFFIC_TITLE", "GremlinGPT GitHub Traffic (Last 14 Days)")  # 👈 new
...
def plot_github_style_merged(clones, views, outfile):
    ...
    ax.set_xlabel("Date")
    ax.set_ylabel("Count")
    ax.set_title(TITLE)  # 👈 use the env-driven title
    ax.legend()
